...
Besides the Tuya credentials, it is **paramount** to enable the **Camera Service** Tuya API on your Tuya IOT Platform (Cloud -> [Your Project] -> Service API and activate "Camera Service")
